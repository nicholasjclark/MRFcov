...
It is important here to examine the level names of factor variables, as the 1st level (i.e. the dummy level) will be dropped from the dataset during conversion to model matrix format (i.e. 'one-hot encoding', as in standard `lme4` analysis of factor covariates)
```{r eval=FALSE}
