...
```{r fig.align = "center",fig.height=3,fig.width=3,message=FALSE}
...
```{r Vignette1.fig1, fig.align = "center",fig.height=3,fig.width=3,message=FALSE}
library(rosalia)
...
```{r Vignette1.fig2, fig.height=3.5, fig.width=4, message=FALSE}
...
```{r Vignette1.fig3, fig.height=4.75, fig.width=5, message=FALSE}
...
```{r Vignette1.fig4,fig.align = "center",fig.height=5.65,fig.width=3,message=FALSE}
...
```{r Vignette1.fig5,fig.align = "center",fig.height=2.5,fig.width=5,message=FALSE}
