...
```{r fig.align = "center",fig.height=3.75,fig.width=4,message=FALSE}
plotMRF_hm(MRF_mod = MRF_mod)
```

Visualise how species interactions are predicted to change across covariate magnitudes
```{r fig.align = "center",fig.height=4.75,fig.width=5,message=FALSE}
...
```{r fig.align = "center",fig.height=5.65,fig.width=3,message=FALSE}
...
```{r fig.align = "center",fig.height=2.75,fig.width=5,message=FALSE}
