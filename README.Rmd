...
# Run an MRF model using a single continuous covariate (scale.prop.zos) and a weak penalization parameter (lambda1) for LASSO variable selection
MRF_mod <- MRFcov(data = Bird.parasites, n_nodes = 4, lambda1 = 1)

# Plot the estimated species interactions
